...
public class NaiveBayesClassifier {
    ...
    public NaiveBayesClassifier(List<Sample> trainingList, List<Sample> testingList) {
    ...
    public double getFeatureProbability(int featureNumber, int classNumber, String featureValue) {
        // we initialize this to 1 to use it as a Laplacian estimator
        int stringFeaturesWithClassNumber = 1;
        for (Sample s : trainingSamples) {
